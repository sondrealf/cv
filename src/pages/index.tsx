...
const index = () => {
  return (
    <InfoProvider>
      <Layout className="grid grid-rows-[22.5rem_repeat(3,minmax(8.625rem,_1fr))] print:grid-rows-[18rem_repeat(3,minmax(6.125rem,_1fr))] sm:grid-cols-[repeat(7,minmax(8.625rem,_1fr))] grid-cols-[repeat(2,minmax(2.625rem,_1fr))] w-full">
